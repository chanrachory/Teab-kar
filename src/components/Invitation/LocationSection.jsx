...
export default function LocationSection({ mapUrl }) {
  ...
  return (
    <section className="py-24 px-6 bg-black/60 backdrop-blur-md text-white relative border-y border-white/10">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-center">
          <div className="w-full max-w-5xl overflow-hidden rounded-3xl shadow-2xl border-2 border-amber-500/30">
            <iframe
              src={mapUrl}
